...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-peach text-[#0D0D0D] font-semibold hover:bg-peach-light',
        outline:
          'border border-peach text-peach hover:bg-peach hover:text-[#0D0D0D] font-semibold',
        ghost: 'hover:bg-surface-2 hover:text-[#F0F0F0]',
        link: 'text-peach underline-offset-4 hover:underline',
        secondary: 'bg-surface-2 text-[#F0F0F0] hover:bg-border',
      },
      size: {
